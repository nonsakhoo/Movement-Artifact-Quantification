...
% This is a naive implementation for proof-of-concept purposes and is not a fully functional script. Please forgive any unoptimized code or bugs.
...
function main()
    ...
    conf_dataset_folder = { ...
        'circle_128px_0_180', ...        % 1 <-- mainly used for demonstration
    ...
    conf_cropping = struct( ...
        ...
        'width', 400, ...           % manually adjusted, default is 400
        'height', 400, ...          % manually adjusted, default is 400
    ...
    conf_algo5_enable = true;                   % Due to this algorithm is not important yet, it is also able to be false.
        ...
        for index = 1:length(image_paths)
            if ismember(index, conf_selected_images)
                ...
                if conf_grayscale_mode
                    ...
                    % The algorithm is not fully implemented yet, but it serves as a placeholder for future development.
                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
